...
#define BQ24190_REG_CCC_BCOLD_MASK		BIT(1)//BQ24296M
#define BQ24190_REG_CCC_BCOLD_SHIFT		1
...
#define BQ24190_REG_PCTCC_ITERM_MASK		(BIT(2) | BIT(1) | BIT(0)) /* for BQ24296M BIT 2-0, for BQ24296/7 BIT 3-0*/
#define BQ24190_REG_PCTCC_ITERM_SHIFT		0
#define BQ24190_REG_PCTCC_ITERM_MIN			128
#define BQ24190_REG_PCTCC_ITERM_MAX			512 /* for BQ24296M 512, for BQ24296/7 1024*/ 
...
#define BQ24190_REG_CTTC_JEITA_ISET_MASK	BIT(0) //not in use on bq24296/7
...
#define BQ24190_REG_ICTRC_VCLAMP_MASK		(BIT(7) | BIT(6) | BIT(5) | BIT(4))
#define BQ24190_REG_ICTRC_VCLAMP_SHIFT		4
#define BQ24190_REG_ICTRC_BHOT_MASK		(BIT(3) | BIT(2)) //BQ24296M
#define BQ24190_REG_ICTRC_BHOT_SHIFT		2
...
#define BQ24190_REG_MOC_JEITA_VSET_MASK		BIT(4) //not in use on bq24296/7?
...
static struct bq24190_sysfs_field_info bq24190_sysfs_field_tbl[] = {
	...
	BQ24190_SYSFS_FIELD_RW(bcold,		CCC,	BCOLD),
	...
	BQ24190_SYSFS_FIELD_RW(bhot,		ICTRC,	BHOT),
